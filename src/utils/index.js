...
export const getToken = () =>{
  ...
  try{
   return  localStorage.getItem('token') != null ? JSON.parse(localStorage.getItem('token')) : null
  }catch (error)
  {
    console.log(">>>> src/utils/index.js : getToken -> error", error)
  }
}
...
export const setToken = (token) =>{
  ...
  {
    console.log(">>>> src/utils/index.js : setToken -> error", error)
  }
}
